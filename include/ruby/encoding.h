...
#define ENCODING_MASK                                                                          \
  (((VALUE)ENCODING_INLINE_MAX)                                                                \
   << ENCODING_SHIFT) /* FL_USER10|FL_USER11|FL_USER12|FL_USER13|FL_USER14|FL_USER15|FL_USER16 \
                         */
...
#define ENC_CODERANGE_AND(a, b)                                                \
  ((a) == ENC_CODERANGE_7BIT                                                   \
       ? (b)                                                                   \
       : (a) == ENC_CODERANGE_VALID                                            \
             ? ((b) == ENC_CODERANGE_7BIT ? ENC_CODERANGE_VALID : (b))         \
...
VALUE rb_enc_str_buf_cat(VALUE str, const char *ptr, long len,
                         rb_encoding *enc);
...
#define rb_enc_prev_char(s, p, e, enc)                                         \
  ((char *)onigenc_get_prev_char_head((enc), (UChar *)(s), (UChar *)(p),       \
                                      (UChar *)(e)))
/* start, ptr, end, encoding -> next_char */
#define rb_enc_left_char_head(s, p, e, enc)                                    \
  ((char *)onigenc_get_left_adjust_char_head((enc), (UChar *)(s),              \
                                             (UChar *)(p), (UChar *)(e)))
#define rb_enc_right_char_head(s, p, e, enc)                                   \
  ((char *)onigenc_get_right_adjust_char_head((enc), (UChar *)(s),             \
                                              (UChar *)(p), (UChar *)(e)))
#define rb_enc_step_back(s, p, e, n, enc)                                      \
  ((char *)onigenc_step_back((enc), (UChar *)(s), (UChar *)(p), (UChar *)(e),  \
                             (int)(n)))
...
#define rb_enc_asciicompat(enc)                                                \
  (rb_enc_mbminlen(enc) == 1 && !rb_enc_dummy_p(enc))
...
long rb_str_coderange_scan_restartable(const char *, const char *,
                                       rb_encoding *, int *);
...
static inline int rb_enc_dummy_p(rb_encoding *enc) {
...
rb_econv_t *rb_econv_open(const char *source_encoding,
                          const char *destination_encoding, int ecflags);
...
int rb_econv_set_replacement(rb_econv_t *ec, const unsigned char *str,
                             size_t len, const char *encname);
...
/* result: 0:success -1:failure */
int rb_econv_insert_output(rb_econv_t *ec, const unsigned char *str, size_t len,
...
VALUE rb_econv_substr_convert(rb_econv_t *ec, VALUE src, long byteoff,
                              long bytesize, int flags);
VALUE rb_econv_str_append(rb_econv_t *ec, VALUE src, VALUE dst, int flags);
VALUE rb_econv_substr_append(rb_econv_t *ec, VALUE src, long byteoff,
                             long bytesize, VALUE dst, int flags);
VALUE rb_econv_append(rb_econv_t *ec, const char *bytesrc, long bytesize,
                      VALUE dst, int flags);
