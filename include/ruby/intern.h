...
VALUE rb_enumeratorize_with_size(VALUE, VALUE, int, VALUE *,
                                 rb_enumerator_size_func *);
#ifndef RUBY_EXPORT
#define rb_enumeratorize_with_size(obj, id, argc, argv, size_fn)               \
  rb_enumeratorize_with_size(obj, id, argc, argv,                              \
...
PRINTF_ARGS(void rb_compile_error_with_enc(const char *, int, void *,
                                           const char *, ...),
            4, 5);
...
#else
static inline void rb_check_frozen_inline(VALUE obj) {
  rb_check_frozen_internal(obj);
}
#define rb_check_frozen(obj) rb_check_frozen_inline(obj)
static inline void rb_check_trusted_inline(VALUE obj) {
...
static inline void rb_check_arity(int argc, int min, int max) {
...
#define rb_fd_select(n, rfds, wfds, efds, timeout)                             \
  rb_w32_select((n), (rfds) ? ((rb_fdset_t *)(rfds))->fdset : NULL,            \
                (wfds) ? ((rb_fdset_t *)(wfds))->fdset : NULL,                 \
                (efds) ? ((rb_fdset_t *)(efds))->fdset : NULL, (timeout))
...
DEPRECATED(int rb_thread_select(int, fd_set *, fd_set *, fd_set *,
                                struct timeval *));
...
DEPRECATED(VALUE rb_exec_arg_init(int argc, VALUE *argv, int accept_shell,
...
DEPRECATED(int rb_run_exec_options(const struct rb_exec_arg *e,
                                   struct rb_exec_arg *s));
DEPRECATED(int rb_run_exec_options_err(const struct rb_exec_arg *e,
                                       struct rb_exec_arg *s, char *, size_t));
...
DEPRECATED(rb_pid_t rb_fork_err(int *, int (*)(void *, char *, size_t), void *,
                                VALUE, char *, size_t));
...
#define rb_str_new_cstr(str)                                                   \
  __extension__({                                                              \
    (__builtin_constant_p(str)) ? rb_str_new((str), (long)strlen(str))         \
                                : rb_str_new_cstr(str);                        \
  })
#define rb_tainted_str_new_cstr(str)                                           \
  __extension__({                                                              \
    (__builtin_constant_p(str)) ? rb_tainted_str_new((str), (long)strlen(str)) \
                                : rb_tainted_str_new_cstr(str);                \
  })
#define rb_usascii_str_new_cstr(str)                                           \
  __extension__({                                                              \
    (__builtin_constant_p(str)) ? rb_usascii_str_new((str), (long)strlen(str)) \
...
#define rb_locale_str_new_cstr(str)                                            \
  __extension__({                                                              \
    (__builtin_constant_p(str)) ? rb_locale_str_new((str), (long)strlen(str))  \
                                : rb_locale_str_new_cstr(str);                 \
  })
#define rb_str_buf_new_cstr(str)                                               \
  __extension__({                                                              \
    (__builtin_constant_p(str))                                                \
        ? rb_str_buf_cat(rb_str_buf_new((long)strlen(str)), (str),             \
                         (long)strlen(str))                                    \
        : rb_str_buf_new_cstr(str);                                            \
  })
#define rb_str_buf_cat2(str, ptr)                                              \
  __extension__({                                                              \
    (__builtin_constant_p(ptr))                                                \
        ? rb_str_buf_cat((str), (ptr), (long)strlen(ptr))                      \
        : rb_str_buf_cat2((str), (ptr));                                       \
  })
#define rb_str_cat2(str, ptr)                                                  \
  __extension__({                                                              \
    (__builtin_constant_p(ptr)) ? rb_str_cat((str), (ptr), (long)strlen(ptr))  \
                                : rb_str_cat2((str), (ptr));                   \
  })
