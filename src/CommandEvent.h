...
class CommandEvent {
 public:
  ...
  CommandEvent(const QString& name,
               boost::optional<core::ConditionExpression> condition,
  ...
  boost::optional<core::ConditionExpression> condition() const { return m_condition; }
 ...
 private:
  ...
  boost::optional<core::ConditionExpression> m_condition;
