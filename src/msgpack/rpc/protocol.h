...
struct msg_request {
  ...
  msg_request(Method method, typename msgpack::type::tuple<Parameter>& param, msgid_t msgid)
...
struct msg_response {
  ...
  msg_response(typename msgpack::type::tuple<Result>& result,
               typename msgpack::type::tuple<Error>& error,
               msgid_t msgid)
...
template <typename Method, typename Parameter>
struct msg_notify {
  msg_notify() : type(NOTIFY) {}

  msg_notify(Method method, typename msgpack::type::tuple<Parameter>& param)
