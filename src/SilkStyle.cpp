...
int SilkStyle::styleHint(StyleHint hint,
  ...
  if (hint == QStyle::SH_ComboBox_Popup) {
    ...
    /*
    at this point I have not used combo->view() because he "crash" the application without
    explanation
    ...
    */
    ...
    if (hasView == true) {
      ...
      for (int i = 0; i < j; ++i) {
        const int textWidth = qMax(fontMetrics1.width(combo->itemText(i) + "WW"),
