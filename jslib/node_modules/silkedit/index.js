...
function tr(key, packageName, defaultValue) {
  var i, j, currentObj, fd, translationPaths;
  packageName = packageName != null ? packageName : 'default';
  try {
            ...
            if (module.commands) {
              if (pjson.name === 'default') {
                ...
                Object.keys(module.commands).forEach((cmd) => {
                  CommandManager.add(cmd, tr("command." + cmd + ".description"), module.commands[cmd]);
                });
              } else {
                Object.keys(module.commands).forEach((cmd) => {
