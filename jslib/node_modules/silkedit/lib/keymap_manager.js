...
const KeymapManager = {
   ...
   */
  dispatch: bridge.KeymapManager.dispatch,
  /**
   * keymap.ymlをロードする。
   * @function
   ...
   */
  load: bridge.KeymapManager.load,
  /**
   * キーイベントフィルターを追加する。
...
class KeyEvent {
  /**
   * @returns {Number} {@link http://doc.qt.io/qt-5/qt.html#Key-enum}
   */
  key() {};
  /**
   * @returns {Number} {@link http://doc.qt.io/qt-5/qevent.html#Type-enum}
   */
  type() {};
}
